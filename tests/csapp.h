...
void Pthread_mutex_init(pthread_mutex_t *mp, const pthread_mutexattr_t *mattr);
...
/* Wrappers for System V shared memory segment */
...
/* POSIX times wrappers and helper functions */
